...
namespace AiChef.Server.Services
{
    public class OpenAIService : IOpenAIAPI
    {
        ...
        private string gptModel = "gpt-3.5-turbo-0125";

        public OpenAIService(IConfiguration configuration)
        {
            _configuration = configuration;
            var apiKey = Environment.GetEnvironmentVariable("OpenAiKey") ?? _configuration["OpenAi:OpenAiKey"];
        ...
        {
            string url = $"{_baseUrl}chat/completions";
            string systemPrompt = "You are a world-renowned chef. Create the recipe with ingredients, instructions and summary.";
        ...
        public async Task<RecipeImage> CreateRecipeImage(string recipeTitle)
        {
            ...
            {
                Console.WriteLine("couldn't get image");
            }
